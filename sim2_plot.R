control0 <- controlP2(eff = 0)
control <- controlP2(eff = 0.90)
...
plot(c(pred, t0$DDs[-(1:which(t0$DDs == pred))]), cumsum(conts0), type = "o", lwd = 2, xlab = "Cumulative degree-days", ylab = "", cex.lab = 2, 
